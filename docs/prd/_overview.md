...
- Pastes task names and assigns project + tags
...
| Feature                                 | Doc                                                              | Status  |
| --------------------------------------- | ---------------------------------------------------------------- | ------- |
| [Time Tracking](time-tracking.md)       | Start/stop timer, entry management, deduplication, tags, reports | Core    |
...
- **Tags:** Mark synced entries, filter by Jira project
