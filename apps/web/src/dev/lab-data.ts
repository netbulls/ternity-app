...
export const LAB_SECTIONS: LabProductSection[] = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        description: 'Settings page organization — 10 layout approaches for structuring all current and upcoming settings (appearance, timer, working hours, attendance, Jira, notifications)',
        date: '2026-02-26T23:30:00',
        items: [
          { kind: 'exploration', title: 'V1 — Vertical Scroll', file: 'web/settings-a2b3.html', description: 'Current extended: flat scrolling page with more sections. Two-column layout with account sidebar. Simple, familiar, grows vertically.', date: '2026-02-26T23:30:00' },
          { kind: 'exploration', title: 'V2 — Left-Nav Categories', file: 'web/settings-c4d5.html', description: 'Sidebar nav grouped by Personal/Work/Integrations. Content area shows one category. GitHub/Linear/Slack pattern.', date: '2026-02-26T23:40:00' },
          { kind: 'exploration', title: 'V3 — Top Tabs', file: 'web/settings-e6f7.html', description: 'Horizontal tab bar: Profile, General, Work, Integrations, Notifications. Each tab switches content. Notion/Figma pattern.', date: '2026-02-26T23:50:00' },
          { kind: 'exploration', title: 'V4 — Collapsible Card Stack', file: 'web/settings-01a9.html', description: 'Accordion cards with inline summaries when collapsed. Expand to edit. iOS Settings pattern.', date: '2026-02-27T00:00:00' },
          { kind: 'exploration', title: 'V5 — Grid Dashboard', file: 'web/settings-2b8c.html', description: 'Bento tiles overview. Each tile shows a summary; clicking opens detail. Good for discovery and at-a-glance overview.', date: '2026-02-27T00:10:00' },
          { kind: 'exploration', title: 'V6 — Segmented Scroll', file: 'web/settings-3d7e.html', description: 'Sticky segmented control at top as jump-links. All content on one page, segments highlight on scroll. Apple Settings + scroll-spy.', date: '2026-02-27T00:20:00' },
          { kind: 'exploration', title: 'V7 — Modal Per Section', file: 'web/settings-4f6a.html', description: 'Compact row list with current values. Click opens focused modal for that setting. iOS/Android pattern. Clean overview, focused editing.', date: '2026-02-27T00:30:00' },
          { kind: 'exploration', title: 'V8 — Two-Column Form', file: 'web/settings-5e9b.html', description: 'Labels/descriptions left, controls right. Classic SaaS form layout (Stripe, GitHub). Clear rhythm, scales to many settings.', date: '2026-02-27T00:40:00' },
          { kind: 'exploration', title: 'V9 — Command Palette', file: 'web/settings-6c8d.html', description: 'Searchable command palette (Cmd+,). Type to filter settings. Power-user friendly. VS Code/Linear/Raycast pattern.', date: '2026-02-27T00:50:00' },
          { kind: 'exploration', title: 'V10 — Minimal Single Column', file: 'web/settings-7a5f.html', description: 'Narrow, borderless, no cards. Labels and values in clean vertical list. Mobile-friendly, ultra-readable. WhatsApp/Telegram feel.', date: '2026-02-27T01:00:00' },
          { kind: 'prototype', title: 'V1 — Vertical Scroll', route: '/dev/settings-v1', description: 'Interactive prototype: two-column grid with scrollable settings (left) and sticky info sidebar (right). Theme/scale switching, project selector, timer toggle, Jira card.', date: '2026-02-27T02:00:00' },
          { kind: 'prototype', title: 'V3 — Top Tabs', route: '/dev/settings-v3', description: 'Interactive prototype: horizontal tab bar (Profile, General, Work, Integrations, Notifications). Tab switching with active underline. Soon badges on Work and Notifications.', date: '2026-02-27T02:10:00' },
          { kind: 'prototype', title: 'V4 — Card Stack', route: '/dev/settings-v4', description: 'Interactive prototype: collapsible accordion cards with expand/collapse animation (motion/react), chevron rotation, icon tint change, inline summaries when collapsed.', date: '2026-02-27T02:20:00' },
        ],
      },
      {
        name: 'jira-search',
        id: 'jira-search-lab',
        description: 'Search and link Jira issues to time entries — 10 UI approaches for search trigger, results display, and linked state',
        date: '2026-02-27T12:00:00',
        items: [
          { kind: 'exploration', title: 'V1 — Inline Expansion', file: 'web/jira-search-a1b2.html', description: 'Jira icon on description input expands inline search panel below. Results in-place, no overlay. Panel grows organically from input.', date: '2026-02-27T12:00:00' },
          { kind: 'exploration', title: 'V2 — Popover Dropdown', file: 'web/jira-search-c3d4.html', description: 'Jira icon triggers floating popover card with arrow. Search input + grouped results. Compact, no layout shift.', date: '2026-02-27T12:10:00' },
          { kind: 'exploration', title: 'V3 — Command Palette', file: 'web/jira-search-e5f6.html', description: 'Full-width command palette overlay (Linear/Raycast style). Centered modal, keyboard-driven, backdrop blur. ⌘J trigger.', date: '2026-02-27T12:20:00' },
          { kind: 'exploration', title: 'V4 — Side Panel', file: 'web/jira-search-g7h8.html', description: 'Right-side drawer with search + results. Timer bar/entry stays visible on left. Project filter chips.', date: '2026-02-27T12:30:00' },
          { kind: 'exploration', title: 'V5 — Smart Description Input', file: 'web/jira-search-i9j0.html', description: 'Type # in description to trigger autocomplete. Issues appear as-you-type below input. Native feel like @mentions.', date: '2026-02-27T12:40:00' },
          { kind: 'exploration', title: 'V6 — Browse then Pick', file: 'web/jira-search-k2m3.html', description: 'Shows assigned/recent issues first without search. Browse-first approach. Search secondary for when browsing fails.', date: '2026-02-27T12:50:00' },
          { kind: 'exploration', title: 'V7 — Chip Trigger', file: 'web/jira-search-m4n5.html', description: 'Small "Link Jira" chip next to description. Clicking opens minimal floating search. Selected issue becomes key chip with link.', date: '2026-02-27T13:00:00' },
          { kind: 'exploration', title: 'V8 — Split Input', file: 'web/jira-search-p6q7.html', description: 'Description splits into Jira badge area (left) + freeform text (right). Clicking badge opens search. Badge shows issue key when linked.', date: '2026-02-27T13:10:00' },
          { kind: 'exploration', title: 'V9 — Contextual Suggest', file: 'web/jira-search-r8s9.html', description: 'Auto-suggests matching Jira issues after typing. Subtle suggestion bar below input. One-click to link. Non-intrusive.', date: '2026-02-27T13:20:00' },
          { kind: 'exploration', title: 'V10 — Dialog with Preview', file: 'web/jira-search-t0u1.html', description: 'Full dialog with search, project/status filters, and split preview pane. Most feature-rich. Power-user friendly.', date: '2026-02-27T13:30:00' },
          { kind: 'prototype', title: 'Jira Search Combined', route: '/dev/jira-search', description: 'Interactive prototype: full app emulation with sidebar. Combines # trigger in description, explicit Jira icon dropdown (V2+V4+V6 hybrid), and ⌘K command palette with 5 start-timer variants.', date: '2026-02-27T14:00:00' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { kind: 'exploration', title: 'V1 — Inline Accordion', file: 'web/jira-settings-b4e7.html', description: 'Connection expands to reveal stacked config sections (Projects, Statuses, JQL). Checkbox lists for multi-select. Compact when collapsed.', date: '2026-02-26T23:00:00' },
          { kind: 'exploration', title: 'V2 — Card Grid', file: 'web/jira-settings-c8a3.html', description: 'Connection header card + separate config cards below (Projects, Statuses, JQL). Chip-based selection. Each card self-contained.', date: '2026-02-26T23:10:00' },
          { kind: 'exploration', title: 'V3 — Sidebar Drawer', file: 'web/jira-settings-d2f1.html', description: 'Connection list on left, config form slides in on right. Tag-style inputs for projects/statuses. Keeps settings page clean.', date: '2026-02-26T23:20:00' },
          { kind: 'exploration', title: 'V4 — Tab Panel', file: 'web/jira-settings-e6b9.html', description: 'Horizontal tabs within connection: Projects | Statuses | Query. Badge counts on tabs. Familiar Jira-like pattern.', date: '2026-02-26T23:30:00' },
          { kind: 'exploration', title: 'V5 — Stepper Wizard', file: 'web/jira-settings-f0d5.html', description: 'Guided 3-step flow: pick projects → pick statuses → review JQL. Progress indicator. Good for first-time setup.', date: '2026-02-26T23:40:00' },
          { kind: 'exploration', title: 'V6 — Floating Config Popover', file: 'web/jira-settings-a3c2.html', description: 'Gear icon on connection opens floating dropdown with all config. Minimal page footprint. Summary pills on the row.', date: '2026-02-26T23:50:00' },
          { kind: 'exploration', title: 'V7 — Full-Width Sections', file: 'web/jira-settings-b7e8.html', description: 'No nesting — each config area is a top-level settings section. Grid of selectable items. Matches existing settings layout.', date: '2026-02-27T00:00:00' },
          { kind: 'exploration', title: 'V8 — Two-Column Split', file: 'web/jira-settings-c1f4.html', description: 'Projects left, statuses right, JQL below. Dense layout — everything visible at once. Chip-based selection.', date: '2026-02-27T00:10:00' },
          { kind: 'exploration', title: 'V9 — Tag Builder', file: 'web/jira-settings-d5a6.html', description: 'Visual JQL builder with chip metaphor. Teal chips for projects, red chips for excluded statuses. "View as JQL" toggle.', date: '2026-02-27T00:20:00' },
          { kind: 'exploration', title: 'V10 — Minimal List', file: 'web/jira-settings-e9b0.html', description: 'Ultra-compact. Token input for projects, toggle pills for statuses, collapsed "Advanced" for JQL. Prioritizes density.', date: '2026-02-27T00:30:00' },
          { kind: 'prototype', title: 'V1 — Inline Accordion', route: '/dev/jira-v1', description: 'Interactive prototype: connection card expands to reveal stacked config sections (checkboxes for projects, excluded statuses with strikethrough, Simple/Custom JQL toggle). Animated expand/collapse with summary when collapsed.', date: '2026-02-27T01:00:00' },
          { kind: 'prototype', title: 'V9 — Tag Builder', route: '/dev/jira-v9', description: 'Interactive prototype: visual JQL builder with inline teal project chips and red excluded status chips. Dashed "+" button opens dropdown to add. "View as JQL" toggle reveals raw query.', date: '2026-02-27T01:10:00' },
          { kind: 'prototype', title: 'V10 — Minimal List', route: '/dev/jira-v10', description: 'Interactive prototype: ultra-compact token input for projects (tags inside bordered input), pill toggle buttons for excluded statuses, collapsible Advanced section with JQL preview.', date: '2026-02-27T01:20:00' },
          { kind: 'prototype', title: 'V1+V10 — Hybrid', route: '/dev/jira-v1v10', description: 'Interactive prototype: V1 accordion structure (expand/collapse with summary) combined with V10 form internals (token input for projects, pill toggles for statuses, collapsible Advanced JQL).', date: '2026-02-27T01:30:00' },
          { kind: 'prototype', title: 'V1+V9 — Hybrid', route: '/dev/jira-v1v9', description: 'Interactive prototype: V1 accordion structure (expand/collapse with summary) combined with V9 tag builder inside (visual JQL sentence with teal project chips and red excluded status chips, "View as JQL" toggle).', date: '2026-02-27T01:40:00' },
        ],
      },
      {
        name: 'adjust-time',
